...
class Top234Tree {
	public Node m_Root = new Node(); // make root node
	...
	public void split(Node thisNode) // split the node
	{
		...
		if (thisNode == m_Root) // if this is the root,
		{
			m_Root = new Node(); // make new root
			parent = m_Root; // root is our parent
			m_Root.connectChild(0, thisNode); // connect to parent
		} else
