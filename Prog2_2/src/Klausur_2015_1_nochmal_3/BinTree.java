...
public class BinTree {
	...
	public float avg_3() {
		int nodes = countNodes3(root);
		int content = countContent3(root, 0);
		return content / nodes;
	}

	public int countNodes3(Node n) {
		return n != null ? 1 + countNodes3(n.left) + countNodes3(n.right) : 0;
	}

	public int countContent3(Node n, int c) {
		if (n != null) {
			c = c + n.value;
			if (n.left != null) {
				c = countContent3(n.left, c);
			}
			if (n.right != null) {
				c = countContent3(n.right, c);
			}
		}
		return c;
	}
