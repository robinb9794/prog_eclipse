...
public class BinTree {
	...
	public boolean isSorted2() {
		return isSorted2(root, false);
	}

	public boolean isSorted2(Node n, boolean sorted) {
		if (n != null) {
			if (n.left != null) {
				if (n.left.value < n.value) {
					sorted = true;
				...
				sorted = isSorted2(n.left, sorted);
			}
			if (n.right != null) {
				if (n.right.value >= n.value) {
					sorted = true;
				...
				sorted = isSorted2(n.right, sorted);
			}
		}
		return sorted;
	}
